  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(widget.border ?? 25.0),
          boxShadow: [
            BoxShadow(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.border ?? 25),
              borderSide: BorderSide(color: SomiColors.grey)),
          errorBorder: OutlineInputBorder(
            borderRadius:
                BorderRadius.all(Radius.circular(widget.border ?? 25.0)),
          ...
          focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.border ?? 25),
              borderSide: BorderSide(color: SomiColors.grey, width: 1.5)),
